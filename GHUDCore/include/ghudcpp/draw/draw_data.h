...
namespace GHUD {
	enum DrawDataFlagBits : uint32 {
		GHUD_DRAW_DATA_FLAG_NONE = 0x00,
		GHUD_DRAW_DATA_FLAG_HAS_TEXTURE = 0x01,
		GHUD_DRAW_DATA_FLAG_HAS_INTERACTION = 0x02,
		GHUD_DRAW_DATA_FLAG_IS_MSDF_TEXT = 0x04,
		GHUD_DRAW_DATA_FLAG_SAMPLER_FILTER_MODE_NEAREST = 0x08,
		GHUD_DRAW_DATA_FLAG_SAMPLER_FILTER_MODE_LINAER = 0x10,
		GHUD_DRAW_DATA_FLAG_SAMPLER_ADDRESS_MODE_REPEAT = 0x20,
		GHUD_DRAW_DATA_FLAG_SAMPLER_ADDRESS_MODE_CLAMP = 0x40,
		GHUD_DRAW_DATA_FLAG_SAMPLER_ADDRESS_MODE_REPEAT_MIRROR = 0x80
	};
